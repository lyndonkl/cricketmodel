...
\textbf{same\_over (NEW)} & \textbf{GATv2Conv} & \textbf{Within-over context patterns} \\
...
\begin{itemize}
    ...
    \item \textbf{Same\_over edges} capture within-over context (bowler plans, batsman reading)
